            ...
            <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-800'>
                <section>
                    <nav className='p-10 mb-12 flex justify-between'>
                        <h1 className='text-2xl font-bold dark:text-white'>MedPAWS</h1>
                ...
                <section>
                    <div>
                        ...
                        <p className='text-md py-2 leading-8 text-gray-800 dark:text-white'>En MedPaws, nuestra prioridad es la salud y el bienestar 
