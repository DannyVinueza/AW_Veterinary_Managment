                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-3">
                            ...
                            <input type="email" name='email'
                                value={form.email || ""} onChange={handleChange} placeholder="Enter you email" className="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-2 text-gray-500" />
                        </div>
